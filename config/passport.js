...
// load all the things we need for local Strategy
var LocalStrategy   = require('passport-local').Strategy;

// load all the things we need for lti Strategy
...
module.exports = function(passport) {
    ...
    function(req, body, done) { // callback
        // LTI launch parameters
        //console.dir(req.body);
        var email = req.body.lis_person_contact_email_primary;
        console.log('lis_outcome_service_url: ' + body.lis_outcome_service_url);
